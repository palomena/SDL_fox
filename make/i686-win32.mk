...
SDL_INCLUDE_PATH := ./deps/win32/SDL2/include
SDL_LIBRARY_PATH := ./deps/win32/SDL2/lib

FREETYPE_INCLUDE_PATH := ./deps/win32/freetype/include/freetype2
FREETYPE_LIBRARY_PATH := ./deps/win32/freetype/lib
